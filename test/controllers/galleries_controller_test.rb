...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { num_photos: @gallery.num_photos, title: @gallery.title } }, as: :json
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { num_photos: @gallery.num_photos, title: @gallery.title } }, as: :json
    assert_response 200
  end
